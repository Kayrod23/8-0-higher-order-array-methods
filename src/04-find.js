...
function findPinkElephantsByTimestreet(songs) {
  let foundIn = songs.find(song => song.title === "Pink Elephants")
  return foundIn
}
...
function findFirstSongUnderThreeMinutes(songs) {
  let firstSongFoundUnder3Min = songs.find(song => song.runtimeInSeconds < 180)
  return firstSongFoundUnder3Min
}
